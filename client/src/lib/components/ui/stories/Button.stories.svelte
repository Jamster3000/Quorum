...
<Story name="Primary" args={{ variant: 'primary', fontSize: 'medium', ariaLabel: "" }} {template} />
<Story name="Secondary" args={{ variant: 'secondary', fontSize: 'medium', ariaLabel: "" }} {template} />
<Story name="Transparent" args={{ variant: 'transparent', fontSize: 'medium', ariaLabel: "" }} {template} />
