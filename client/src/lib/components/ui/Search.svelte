<script>
    ...
    async function handleSearch() {
        try {
            const response = await invoke("search", { query: searchText });
...
<div class="searchBox">
    <input class="searchInput" type={type} placeholder={placeholder} bind:value={searchText}>
    <button class="searchButton" on:click={handleSearch}>
